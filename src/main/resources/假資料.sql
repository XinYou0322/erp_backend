...
INSERT INTO products
    (sku, name, category, selling_price, cost_price, unit, status)
VALUES
    ('DRINK-001', N'珍珠奶茶', N'奶茶類', 65.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-002', N'四季春青茶', N'純茶類', 35.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-003', N'阿薩姆紅茶', N'純茶類', 30.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-004', N'百香綠茶', N'果茶類', 55.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-005', N'黑糖珍珠鮮奶', N'奶茶類', 75.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-006', N'檸檬青茶', N'果茶類', 60.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-007', N'仙草凍奶茶', N'奶茶類', 65.00, 0.00, N'杯', 'ACTIVE'),

    ('DRINK-008', N'冬瓜檸檬', N'特調類', 50.00, 0.00, N'杯', 'ACTIVE');
