...
BEGIN TRY
    ...
    VALUES
        ...
        ('MAT002', N'茉香綠茶葉',   N'g',  'CONVERSION', N'包', 'ACTIVE', 2500.0000,  750.0000, 0.3000, 5000.0000),
        ('MAT003', N'四季春茶葉',   N'g',  'CONVERSION', N'包', 'ACTIVE', 2500.0000,  880.0000, 0.3520, 4000.0000),
        ('MAT004', N'伯爵紅茶葉',   N'g',  'CONVERSION', N'包', 'ACTIVE', 2500.0000, 1025.0000, 0.4100, 3000.0000),
        ('MAT005', N'全脂鮮奶',     N'ml', 'CONVERSION', N'瓶', 'ACTIVE', 1858.0000,  150.0000, 0.0807, 8000.0000),
        ('MAT006', N'奶精粉',       N'g',  'CONVERSION', N'包', 'ACTIVE', 1000.0000,  900.0000, 0.9000, 3000.0000),
        ('MAT007', N'果糖糖漿',     N'ml', 'CONVERSION', N'桶', 'ACTIVE', 5000.0000,  520.0000, 0.1040, 8000.0000),
        ('MAT008', N'黑糖珍珠',     N'g',  'CONVERSION', N'包', 'ACTIVE', 3000.0000,  270.0000, 0.0900, 6000.0000),
        ('MAT009', N'椰果',         N'g',  'CONVERSION', N'桶', 'ACTIVE', 3000.0000,  480.0000, 0.1600, 3000.0000),
        ('MAT010', N'仙草凍',       N'g',  'CONVERSION', N'桶', 'ACTIVE', 3000.0000,  430.0000, 0.1433, 3000.0000),
        ('MAT011', N'檸檬原汁',     N'ml', 'CONVERSION', N'桶', 'ACTIVE', 5000.0000,  750.0000, 0.1500, 5000.0000),
        ('MAT012', N'百香果原汁',   N'ml', 'CONVERSION', N'桶', 'ACTIVE', 5000.0000, 1300.0000, 0.2600, 4000.0000),
        ('MAT013', N'芒果果泥',     N'ml', 'CONVERSION', N'桶', 'ACTIVE', 5000.0000, 1450.0000, 0.2900, 4000.0000),
        ('MAT014', N'咖啡豆',       N'g',  'CONVERSION', N'包', 'ACTIVE', 1000.0000,  650.0000, 0.6500, 2000.0000),
        ...
        ('MAT021', N'舊版奶精粉',   N'g',  'CONVERSION', N'包', 'INACTIVE',1000.0000,  850.0000, 0.8500, 1000.0000);
    ...
    VALUES
        ('P001', N'阿薩姆紅茶',     N'原茶類',   35.00,  8.50, N'杯', 'ACTIVE'),
        ('P002', N'茉香綠茶',       N'原茶類',   35.00,  8.20, N'杯', 'ACTIVE'),
        ('P003', N'四季春青茶',     N'原茶類',   40.00,  9.00, N'杯', 'ACTIVE'),
        ('P004', N'伯爵紅茶',       N'原茶類',   45.00, 10.50, N'杯', 'ACTIVE'),
        ('P005', N'經典奶茶',       N'奶茶類',   50.00, 16.00, N'杯', 'ACTIVE'),
        ('P006', N'伯爵奶茶',       N'奶茶類',   55.00, 17.50, N'杯', 'ACTIVE'),
        ('P007', N'紅茶鮮奶',       N'奶茶類',   65.00, 28.00, N'杯', 'ACTIVE'),
        ('P008', N'珍珠奶茶',       N'奶茶類',   60.00, 22.00, N'杯', 'ACTIVE'),
        ('P009', N'黑糖珍珠鮮奶',   N'奶茶類',   75.00, 34.00, N'杯', 'ACTIVE'),
        ('P010', N'檸檬紅茶',       N'鮮果茶類', 55.00, 16.00, N'杯', 'ACTIVE'),
        ('P011', N'翡翠檸檬',       N'鮮果茶類', 60.00, 17.00, N'杯', 'ACTIVE'),
        ('P012', N'百香綠茶',       N'鮮果茶類', 60.00, 19.00, N'杯', 'ACTIVE'),
        ('P013', N'芒果青茶',       N'鮮果茶類', 65.00, 21.00, N'杯', 'ACTIVE'),
        ('P014', N'椰果綠茶',       N'特調類',   50.00, 15.00, N'杯', 'ACTIVE'),
        ('P015', N'仙草奶茶',       N'特調類',   60.00, 22.00, N'杯', 'ACTIVE'),
        ('P016', N'美式咖啡',       N'咖啡類',   55.00, 18.00, N'杯', 'ACTIVE'),
        ('P017', N'拿鐵咖啡',       N'咖啡類',   75.00, 36.00, N'杯', 'ACTIVE'),
        ('P018', N'巧克力鮮奶',     N'特調類',   70.00, 33.00, N'杯', 'ACTIVE'),
        ('P019', N'百香雙Q綠茶',    N'特調類',   70.00, 25.00, N'杯', 'ACTIVE'),
        ('P020', N'黑糖珍珠奶茶',   N'奶茶類',   70.00, 27.00, N'杯', 'ACTIVE'),
        ('P021', N'舊版奶精紅茶',   N'下架商品', 45.00, 14.00, N'杯', 'INACTIVE');
